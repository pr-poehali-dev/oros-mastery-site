...
const Contact = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Да! Мы всегда рады новым авторам. Напишите нам с примерами своих работ или темами, которые вы хотели бы осветить. Мы ищем людей, способных создавать качественный аналитический контент о Рик и Морти.'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      <SEO
        title="Контакты"
        description="Свяжитесь с командой Рик и Морти Fan Site. Email, Telegram-сообщество, форма обратной связи. Мы всегда рады ответить на ваши вопросы и предложения."
        keywords="Рик и Морти, контакты, связаться, email, telegram, обратная связь, поддержка"
      />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Есть вопросы, предложения или хотите поделиться своей теорией о Рик и Морти? 
