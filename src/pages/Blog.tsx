...
const Blog = () => {
  ...
  const blogPostsOld = [
    {
      id: 1,
      title: 'Топ-10 лучших эпизодов Рик и Морти',
    ...
    {
      id: 2,
      title: 'Теория мультивселенной в Рик и Морти',
    ...
    },
    {
      ...
      excerpt: 'Почему Рик и Морти — это больше, чем просто мультик. Разбираем философские концепции и экзистенциализм.',
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container px-4 space-y-12">
          <Card className="bg-gray-800/60 backdrop-blur-sm border-gray-700/50 p-8 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-100 mb-4 text-center">Изучай вселенную Рик и Морти</h3>
