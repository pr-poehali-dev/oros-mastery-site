...
const SEO = ({
  ...
  useEffect(() => {
    ...
    const metaTags = [
      ...
      { property: 'og:title', content: `${title} | Рик и Морти фан-сайт` },
      ...
      { name: 'twitter:site', content: '@rickandmorty' },
      { name: 'twitter:creator', content: '@rickandmorty' },
      { name: 'twitter:title', content: `${title} | Рик и Морти фан-сайт` },
