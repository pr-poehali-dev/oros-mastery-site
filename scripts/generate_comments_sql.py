...
EPISODES = [
    ...
    (2, 1, 2, "Lawnmower Dog"),
    (3, 1, 3, "Anatomy Park"),
    (4, 1, 4, "M. Night Shaym-Aliens!"),
    (5, 1, 5, "Meeseeks and Destroy"),
    (6, 1, 6, "Rick Potion #9"),
    (7, 1, 7, "Raising Gazorpazorp"),
    (8, 1, 8, "Rixty Minutes"),
    (9, 1, 9, "Something Ricked This Way Comes"),
    (10, 1, 10, "Close Rick-counters of the Rick Kind"),
    (11, 1, 11, "Ricksy Business"),
    # Сезон 2 - 10 эпизодов
    (12, 2, 1, "A Rickle in Time"),
    (13, 2, 2, "Mortynight Run"),
    (14, 2, 3, "Auto Erotic Assimilation"),
    (15, 2, 4, "Total Rickall"),
    (16, 2, 5, "Get Schwifty"),
    (17, 2, 6, "The Ricks Must Be Crazy"),
    (18, 2, 7, "Big Trouble in Little Sanchez"),
    (19, 2, 8, "Interdimensional Cable 2: Tempting Fate"),
    (20, 2, 9, "Look Who's Purging Now"),
    (21, 2, 10, "The Wedding Squanchers"),
    # Сезон 3 - 10 эпизодов
    (22, 3, 1, "The Rickshank Rickdemption"),
    (23, 3, 2, "Rickmancing the Stone"),
    (24, 3, 3, "Pickle Rick"),
    (25, 3, 4, "Vindicators 3: The Return of Worldender"),
    (26, 3, 5, "The Whirly Dirly Conspiracy"),
    (27, 3, 6, "Rest and Ricklaxation"),
    (28, 3, 7, "The Ricklantis Mixup"),
    (29, 3, 8, "Morty's Mind Blowers"),
    (30, 3, 9, "The ABC's of Beth"),
    (31, 3, 10, "The Rickchurian Mortydate"),
    # Сезон 4 - 10 эпизодов
    (32, 4, 1, "Edge of Tomorty: Rick Die Rickpeat"),
    (33, 4, 2, "The Old Man and the Seat"),
    (34, 4, 3, "One Crew Over the Crewcoo's Morty"),
    (35, 4, 4, "Claw and Hoarder: Special Ricktim's Morty"),
    (36, 4, 5, "Rattlestar Ricklactica"),
    (37, 4, 6, "Never Ricking Morty"),
    (38, 4, 7, "Promortyus"),
    (39, 4, 8, "The Vat of Acid Episode"),
    (40, 4, 9, "Childrick of Mort"),
    (41, 4, 10, "Star Mort Rickturn of the Jerri"),
    # Сезон 5 - 10 эпизодов
    (42, 5, 1, "Mort Dinner Rick Andre"),
    (43, 5, 2, "Mortyplicity"),
    (44, 5, 3, "A Rickconvenient Mort"),
    (45, 5, 4, "Rickdependence Spray"),
    (46, 5, 5, "Amortycan Grickfitti"),
    (47, 5, 6, "Rick & Morty's Thanksploitation Spectacular"),
    (48, 5, 7, "Gotron Jerrysis Rickvangelion"),
    (49, 5, 8, "Rickternal Friendshine of the Spotless Mort"),
    (50, 5, 9, "Forgetting Sarick Mortshall"),
...
def main():
    ...
    output_file = "db_migrations/V0034__fill_episode_comments.sql"
    
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("-- Заполнение комментариев к эпизодам\n")
        f.write("-- Генерируем от 30 до 100 комментариев для каждого эпизода\n\n")
        ...
        for i in range(0, len(all_comments), chunk_size):
            ...
            f.write("INSERT INTO episode_comments (episode_id, author_name, author_avatar, comment_text, rating, created_at) VALUES\n")
            f.write(",\n".join(chunk))
            f.write(";\n\n")
    
    print(f"✅ SQL файл сгенерирован: {output_file}")
